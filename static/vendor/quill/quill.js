...
var COLORS = ["#000000", "#e60000", "#ff9900", "#000000f00", "#008a00", "#0066cc", "#9933ff", "#000000", "#facccc", "#ffebcc", "#000000fcc", "#cce8cc", "#cce0f5", "#ebd6ff", "#bbbbbb", "#f06666", "#ffc266", "#000000f66", "#66b966", "#66a3e0", "#c285ff", "#888888", "#a10000", "#b26b00", "#b2b200", "#006100", "#0047b2", "#6b24b2", "#444444", "#5c0000", "#663d00", "#666600", "#003700", "#002966", "#3d1466"];
    ...
    value: function buildPickers(selects, icons) {
      ...
      this.pickers = selects.map(function (select) {
        if (select.classList.contains('ql-align')) {
          ...
          if (select.querySelector('option') == null) {
            fillSelect(select, COLORS, format === 'background' ? '#000000' : '#000000');
          }
